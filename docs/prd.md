...
- Config keys: `download_model`, `model_size`, `language`, `model_pool_languages`, `device`, `sample_rate`, `format`, `vad`, `mode`.
...
- Model download/storage overhead: preload only commonly used languages in `model_pool_languages`.
